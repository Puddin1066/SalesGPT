        ...
        try:
            with self.db_manager.session() as session:
                ...
                result = {
                    ...
                    "persona": getattr(lead, "persona", None),
                    "status": lead.status,
                    ...
                    "free_signup_at": lead.free_signup_at.isoformat() if getattr(lead, "free_signup_at", None) else None,
                    "paid_pro_at": lead.paid_pro_at.isoformat() if getattr(lead, "paid_pro_at", None) else None,
                    "paid_pro_price_id": getattr(lead, "paid_pro_price_id", None),
                    "paid_pro_invoice_id": getattr(lead, "paid_pro_invoice_id", None),
                    "paid_pro_amount": getattr(lead, "paid_pro_amount", None),
        ...
        try:
            with self.db_manager.session() as session:
                ...
                field_map = {
                    ...
                    "free_signup_at": "free_signup_at",
                    "paid_pro_at": "paid_pro_at",
                    "paid_pro_price_id": "paid_pro_price_id",
                    "paid_pro_invoice_id": "paid_pro_invoice_id",
                    "paid_pro_amount": "paid_pro_amount",
                }
